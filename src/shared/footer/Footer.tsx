...
export const Footer: FC = () => {
    return (
        <>
            ...
            <Text>Feel free to reach out! ✌️</Text>
            <Box pt="16">
            ...
            >
                <Text>"You only live once, but if you do it right, once is enough."</Text>

                <Text>NoCtrlZ - &copy; {new Date().getFullYear()} All rights reserved.</Text>
            </Flex>
        </>
    );
};
